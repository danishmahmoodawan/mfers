...
function Home() {
   ...
   <> 
	...
	<div className="container-fluid">
		<div className="row adj_row mfer_row">
			<div id="first" className="col-sm-12 col-md-6 col-lg-4 text-left mfer_col">
					<h1 className="headig_set">MFERS Title</h1>
                    <img src="../assets/images/character_img.png" />
				</div>
                
                <div id="second" className="col-sm-12 col-md-6 col-lg-4 text-center">
            ...
            <div className="main_divider"></div>
                ...
                <div id="third" className="col-sm-12 col-md-6 col-lg-4 text-right">
  ...
  <div className="text-block">
    ...
    <a className="buttonsw" href="https://discord.com" target={{target:"_blank"}}>Cross Chain</a>
                ...
                <div className="row adj_row mfer_row">
			<div id="fourth" className="col-sm-12 col-md-6 col-lg-4 text-left img_set mfer_col">
                    <img src="../assets/images/character_img.png" />
				</div>
                
                <div id="fifth" className="col-sm-12 col-md-6 col-lg-4 text-center ">
                ...
                <div className="row minted_row">
			       <div className="col-3 cent_icon"> <a href="#"><img src="assets/images/plus.svg" alt="" /></a></div>
					<div className="col-6 cent_icon"><h1 className="counted">5</h1></div>
    ...
    <a className="button_mint" href="https://discord.com" target={{target:"_blank"}}>Mint Now</a> </div>
                ...
                <div id="sixth"  className="col-sm-12 col-md-6 col-lg-4 suply_col">
                <h1>Supply On</h1>
...
<div className="row token_box ">
                <div className="col-12 text-center mt-5 mb-5">
 <div className=""><span className="token_id">Token ID: </span></div>
 <img src="../assets/images/line-purple.png" />
 <div className=""><span className="tokeneth">move to
ethereum </span></div>
 <img src="../assets/images/line-purple.png" />
                </div>
                </div>
