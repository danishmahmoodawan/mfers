...
<p className="paraset">
Lorem ipsum dolor sit amet,<br /> consectetur adipiscing elit. Fusce<br /> faucibus elementum euismod. Nullam ut nunc interdum, vehicula nisi elementum, tincidunt mi. Phasellus orci massa, convallis sed aliquet ac, cursus mollis urna. Praesent nec accumsan urna.
</p>
				</div>
                </div>
                <div className="row">
