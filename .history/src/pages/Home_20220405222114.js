...
function Home() {
   ...
   <> 
	...
	<div class="container-fluid">
		<div class="row adj_row">
			<div class="col-sm-12 col-md-6 col-lg-4 mt-5 mb-5 text-left">
					<h1>MFERS Title</h1>
  ...
  <div class="text-block">
    <button class="button buttonsw" href="https://discord.com" target={{target:"_blank"}}>Connect Wallet</button>
  </div>
                    </div>
				</div>
